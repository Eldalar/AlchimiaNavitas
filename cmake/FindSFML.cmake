...
if(SFML_STATIC_LIBRARIES)
    ...
    if(NOT ${FIND_SFML_GRAPHICS_COMPONENT} EQUAL -1)
        ...
        # find libraries
        find_sfml_dependency(FREETYPE_LIBRARY "FreeType" freetype libfreetype)
        find_sfml_dependency(GLEW_LIBRARY "GLEW" libglew glew GLEW glew32 glew32s glew64 glew64s)
        find_sfml_dependency(JPEG_LIBRARY "libjpeg" jpeg libjpeg)
    ...
    if(NOT ${FIND_SFML_AUDIO_COMPONENT} EQUAL -1)
        ...
        find_sfml_dependency(SNDFILE_LIBRARY "libsndfile" sndfile libsndfile)
